    ...
    \newcommand{\makeheaders} {
        ...
        \begin{titlepage}
            ...
            \begin{tabular}{rrc}
                ...
                \rule{0pt}{1.05cm}&\multicolumn{1}{r}{}      & \underline{\parbox[c]{6cm}{\xiaoer\hei{\@titleOnTheSecondLine}}} \\
                \rule{0pt}{1.05cm}&\xiaosi\hei{学~生~姓~名 :} & \underline{\parbox[c]{6cm}{\centerline{\xiaosan\song{\@author}}}} \\
                \rule{0pt}{1.05cm}&\xiaosi\hei{学~生~学~号 :} & \underline{\parbox[c]{6cm}{\centerline{\xiaosan\song{\@studentid}}}} \\
                \rule{0pt}{1.05cm}&\xiaosi\hei{专~业~班~级 :} & \underline{\parbox[c]{6cm}{\centerline{\xiaosan\song{\@subject}}}} \\
                \rule{0pt}{1.05cm}&\xiaosi\hei{学~院~名~称 :} & \underline{\parbox[c]{6cm}{\centerline{\xiaosan\song{\@faculty}}}} \\
                \rule{0pt}{1.05cm}&\xiaosi\hei{指~导~老~师 :} & \underline{\parbox[c]{6cm}{\centerline{\xiaosan\song{\@teacher}}}}\\
            \end{tabular}
            \end{table}\par
            \vspace{2em}
