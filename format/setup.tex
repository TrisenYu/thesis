...
\setlength{\headsep}{3cm-1.5cm-9pt}
\setlength{\textheight}{\paperheight-5.5cm}
\setlength{\foorskip}{0.75cm}
...
\newcommand{\biaoti}{\fontsize{42pt}{42pt}\selectfont}      % 初号号, 1.倍行距
...
\titlecontents{section}[0em]{\xiaosi\hei\vspace{0.5em}} %
...
% ---------------------------------------------------------------------------------
% 1.{section}:标题级别
% 2.[4em]:标题位置 (左间距，理解为缩进)
% 3.{\bfseries \zihao{5} \vspace{10pt}}:
%     标题格式 (设置标题的整体格式，如字体尺寸、粗细、与上一个标题的垂直距离等，可空置)
% 4.{\contentslabel{4em}}:
%     标题标志 (设置标题标志的格式，如序号格式、序号宽度、序号与标题内容之间的间距等，不可空置)
% 5.{\hspace*{-4em}}:
%     无序号标题 (设置无序号标题的格式，如字体、字体尺寸、位置等。该参数可以空置)
% 6.{~\titlerule*[0.6pc]{$.$}~\contentspage}:
...
%% 封面配置
    ...
    \newcommand{\makeheaders}{
        ...
        \begin{titlepage}
            ...
            \begin{spacing}{2.1}
                % 这里需要自己来分自己的题目。
                \put(37,60){\xiaoer\hei{论文(设计)题目:} \xiaoer\hei\underline{\makebox[\@title@width][l]{\@titleOnTheFirstLine}}} \\
                \put(91,80){\xiaoer\hei{\qquad\qquad } \xiaoer\hei\underline{\makebox[\@title@width][l]{\@titleOnTheSecondLine}}} \\
        ...
        \addcontentsline{toc}{section}{\@declaredtitle和\@authorizedtitle} { 
            ...
            \begin{center}
                \hei\xiaoer{湖\ 南\ 大\ 学}
            \end{center}\par\vspace{0.25\baselineskip}
            \begin{center}
            ...
            \song\xiaosi
            \@studentsign \makebox[3cm][s]{} \qquad\qquad\qquad  
            \@cdatename 20\makebox[0.5cm][s]{} 年 \makebox[0.5cm][s]{} 月 \makebox[0.5cm][s]{} 日\par
