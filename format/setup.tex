...
\makeatletter
    ...
    \newcommand{\makeheaders} {
        ...
        \begin{titlepage}
            ...
            \begin{center}
            \begin{tabular}{rrc}
                \rule{0pt}{1.05cm}\multicolumn{2}{r}{\xiaoer\hei{论文(设计)题目:}} & \underline{\parbox[c]{6cm}{\xiaoer\hei{\@titleOnTheFirstLine}}} \\
                \rule{0pt}{1.05cm}&\multicolumn{1}{l}{}      & \underline{\parbox[c]{6cm}{\xiaoer\hei{\@titleOnTheSecondLine}}} \\
                \rule{0pt}{1.05cm}&\xiaosi\hei{学~生~姓~名 :} & \underline{\parbox[c]{6cm}{\xiaosan\song{\@author}}} \\
                \rule{0pt}{1.05cm}&\xiaosi\hei{学~生~学~号 :} & \underline{\parbox[c]{6cm}{\xiaosan\song{\@studentid}}} \\
                \rule{0pt}{1.05cm}&\xiaosi\hei{专~业~班~级 :} & \underline{\parbox[c]{6cm}{\xiaosan\song{\@subject}}} \\
                \rule{0pt}{1.05cm}&\xiaosi\hei{学~院~名~称 :} & \underline{\parbox[c]{6cm}{\xiaosan\song{\@faculty}}} \\
                \rule{0pt}{1.05cm}&\xiaosi\hei{指~导~老~师 :} & \underline{\parbox[c]{6cm}{\xiaosan\song{\@teacher}}}\\
            \end{tabular}\par
            \vspace{3em}
