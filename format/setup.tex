...
%% 封面配置
    ...
    \newcommand{\makeheaders}{
        ...
        \begin{titlepage}
            ...
            \begin{spacing}{2.1}
                % 这里需要自己来分。
                \put(37,60){\xiaoer\hei{论文(设计)题目:} \xiaoer\hei\underline{\makebox[\@title@width][l]{WebAssembly和eBPF}}} \\
                \put(91,80){\xiaoer\hei{\qquad\qquad } \xiaoer\hei\underline{\makebox[\@title@width][l]{的安全机制优化研究}}} \\
