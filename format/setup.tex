...
\setlength{\headheight}{12pt} % 页眉可以放得大一点
...
{\textbf{\thecontentslabel}\ \ } % 标题格式 (设置标题的整体格式，如字体尺寸、粗细、与上一个标题的垂直距离等，可空置)
{} 
...
%% 封面配置
    ...
    \newcommand{\makeheaders}{
        ...
        \begin{titlepage}
            ...
            \begin{spacing}{2.1}
                % 这里需要自己来分自己的题目。
                \put(37,60){\xiaoer\hei{论文(设计)题目:} \xiaoer\hei\underline{\makebox[\@title@width][l]{\@titleOnTheFirstLine}}} \par
                \put(91,80){\xiaoer\hei{\qquad\qquad } \xiaoer\hei\underline{\makebox[\@title@width][l]{\@titleOnTheSecondLine}}} \par
                % 这里需要自己来分自己的题目。
